      ...
      <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div className="grid gap-3 md:grid-cols-[1fr_190px_170px] md:items-end">
          <label className="space-y-2">
            ...
            <select
              value={harmonyMode}
              onChange={(event) => onHarmonyModeChange(event.target.value as HarmonyMode)}
          ...
          <label className="space-y-2">
            ...
            <div className="flex h-12 items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-3 dark:border-slate-800 dark:bg-slate-950">
              <input
                type="color"
                value={baseColor}
          ...
          <button
            ...
            className="flex h-12 items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-slate-50 px-4 text-sm font-black text-slate-950 transition hover:bg-blue-500/10 hover:text-blue-600 dark:border-slate-800 dark:bg-slate-950 dark:text-white"
          >
